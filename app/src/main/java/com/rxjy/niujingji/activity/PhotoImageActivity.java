...
import com.rxjy.niujingji.adapter.MyViewPagerAdapter;
...
public class PhotoImageActivity extends BaseActivity<UpdUserInfoPresenter> implements UpdUserInfoContract.View {
    @Bind(R.id.iv_back)
    ImageView ivBack;
    ...
    public void initData() {
        ...
        tvText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PictureSelector.create(PhotoImageActivity.this)
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                case PictureConfig.CHOOSE_REQUEST:
                    ...
                    mPresenter.upHeaderPicture(App.token, App.cardNo, localMedias.get(0).getCutPath());
                    break;
            }
        }
    }
